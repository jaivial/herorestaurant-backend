...
-- index lets the optimizer filter on the full prefix and keeps the rows
-- pre-sorted, avoiding the filesort (the PK `id` is appended implicitly by
-- InnoDB, covering the trailing `id`).
