...
--
-- SECURITY: never commit real credentials. The SMTP/Gmail secret is set from
-- the backoffice (Configuracion -> Email) and kept server-side only; it is
-- intentionally neither seeded here nor updated on re-run.
...
VALUES
  (1, 'smtp', 'smtp.titan.email', 587, 'reservas@alqueriavillacarmen.com', '', 'tls', 'reservas@alqueriavillacarmen.com', '', '', 1)
