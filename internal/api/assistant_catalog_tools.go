...
func assistantCatalogToolDefs() []assistantToolDef {
	return []assistantToolDef{
		...
		{Name: "catalog_create", Description: "Crea recurso del restaurante activo. Requiere confirmed=true.", InputSchema: json.RawMessage(`{"type":"object","properties":{"resource":{"type":"string"},"name":{"type":"string"},"description":{"type":"string"},"price":{"type":"number"},"confirmed":{"type":"boolean"}},"required":["resource","name","confirmed"]}`)},
		{Name: "catalog_update", Description: "Actualiza recurso del restaurante activo. Requiere confirmed=true.", InputSchema: json.RawMessage(`{"type":"object","properties":{"resource":{"type":"string"},"id":{"type":"integer"},"name":{"type":"string"},"description":{"type":"string"},"price":{"type":"number"},"confirmed":{"type":"boolean"}},"required":["resource","id","confirmed"]}`)},
		{Name: "catalog_delete", Description: "Elimina/desactiva recurso del restaurante activo. Requiere confirmed=true.", InputSchema: json.RawMessage(`{"type":"object","properties":{"resource":{"type":"string"},"id":{"type":"integer"},"confirmed":{"type":"boolean"}},"required":["resource","id","confirmed"]}`)},
