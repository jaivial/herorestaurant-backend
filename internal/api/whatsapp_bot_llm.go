...
// using the same credentials as the translation system.
func (s *Server) botLLMCall(ctx context.Context, system string, messages []botMessage, tools []botToolDef) (botLLMResponse, error) {
